...
const themes = {
  predawn: {
    ...
    rayA: [1.00, 0.90, 0.44], rayB: [1.00, 0.20, 0.62],
    bgA: [0.30, 0.26, 0.62], bgB: [0.14, 0.15, 0.38], bgC: [0.04, 0.06, 0.20],
  },
  sunrise: {
    label: 'Sunrise', icon: 'sunrise',
    rayA: [0.00, 0.12, 0.90], rayB: [0.08, 0.94, 1.00],
    bgA: [0.94, 0.52, 0.30], bgB: [0.66, 0.22, 0.22], bgC: [0.36, 0.16, 0.42],
  },
  daytime: {
    label: 'Daytime', icon: 'sun',
    rayA: [1.00, 0.10, 0.30], rayB: [1.00, 0.74, 0.06],
    bgA: [0.34, 0.78, 0.76], bgB: [0.16, 0.52, 0.66], bgC: [0.22, 0.58, 0.44],
  },
  dusk: {
  ...
  sunset: {
    ...
    rayA: [0.00, 0.12, 1.00], rayB: [0.12, 1.00, 1.00],
    bgA: [0.78, 0.24, 0.18], bgB: [0.44, 0.06, 0.26], bgC: [0.16, 0.08, 0.38],
  },
  night: {
